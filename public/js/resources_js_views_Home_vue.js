...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'Home',
  components: {
    Lane: _components__WEBPACK_IMPORTED_MODULE_0__.Lane,
    Card: _components__WEBPACK_IMPORTED_MODULE_0__.Card,
    Button: _components__WEBPACK_IMPORTED_MODULE_0__.Button
  },
  data: function data() {
    return {
      isLoading: true,
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapGetters)(['servers', 'serverSelected', 'dataServerSNMP'])),
  methods: {
    handleRequest: function handleRequest() {
      ...
      fetch("".concat(API_URL, "/snmp/").concat(this.serverSelected.ip), {
        ...
        if (_this.isDebug) console.log("Consult Host", data);
        _this.error = null;
        _this.resultsValues = Object.values(data.results);
        _this.resultsKeys = Object.keys(data.results);
          ...
          ? _c(
              ...
              [
                ...
                _vm.error
                  ? _c("div", [
                      _vm._v(
                        "\n        Hubo un error en la IP del server, intente con la primer opcion\n      "
                      )
                    ])
                  : _vm._e()
              ],
